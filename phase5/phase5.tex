...
\caption{Initial access screen.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/2.eps}
\caption{User logs in using the "login" link.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/1.eps}
\caption{Back to the top page, now logged in.}
\end{figure}

\begin{figure}[h]
\scalebox{.75}{\includegraphics{walkthrough/4.eps}}
\caption{Create an event through the "event/create" link.}
\end{figure}

\begin{figure}[h]
\scalebox{.75}{\includegraphics{walkthrough/5.eps}}
\caption{Confirming an event brings you to the event's page.}
\end{figure}

\begin{figure}[h]
\scalebox{.75}{\includegraphics{walkthrough/6.eps}}
\caption{Create reservation for the event through the "Add New" link.}
\end{figure}

\begin{figure}[h]
\scalebox{.75}{\includegraphics{walkthrough/7.eps}}
\caption{Hitting the "Create" link brings you to the reservation page.}
\end{figure}
...
\begin{figure}[h]
\includegraphics{walkthrough/11.eps}
\caption{Go back up.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/12.eps}
\caption{Log out using the "logout" link.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/13.eps}
\caption{Now an admin logs in useing the "login" link.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/14.eps}
\caption{Back to the top page, now logged in.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/15.eps}
\caption{Go into the events listing through the "events" link.}
\end{figure}

\begin{figure}[h]
\includegraphics{walkthrough/16.eps}
\caption{Navigated to Example Event page through appropriate link.}
\end{figure}

\begin{figure}[h]
\scalebox{.75}{\includegraphics{walkthrough/17.eps}}
\caption{Approve the event through the "Approve" link.}
\end{figure}

\begin{figure}[h]
\scalebox{.75}{\includegraphics{walkthrough/18.eps}}
\caption{Confirm the reservation and you're back to the reservation, now approved.}
\end{figure}
